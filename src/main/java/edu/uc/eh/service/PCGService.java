...
//    }
    ...
    public ArrayList<Integer> checkGenes(String[] geneList)
    {
        ...
        geneFile = UtilsIO.getInstance().readListFile("/PCG/protein-coding-genes-all.json");
        geneIndex = UtilsIO.getInstance().readListFile("/PCG/protein-coding-genes-index.json");
        ...
        for (int i = 0; i < geneList.length; i++) {
            ...
            index = geneFile.indexOf(geneList[i]);
    ...
    public JSONArray getTable(ArrayList<Integer> genePositions) {
        ...
        notValid.put("name","Not a Protein Coding Gene!");
        notValid.put("symbol","");
        ...
        try{
            ...
            //log.info("hereeeeee1");
            geneCardInfo = UtilsIO.getInstance().readJsonArrayFile("/PCG/protein-coding-genes-info.json");
